	...
	<a-spin :spinning="loadSpinning">
		...
		>
			...
			<a-row :gutter="16">
				...
				<a-col :span="16">
					<a-form-item label="打印服务器：" name="SNOWY_SYS_PRINT_HOST">
						<a-input v-model:value="formData.SNOWY_SYS_PRINT_HOST" placeholder="请输入打印服务器" />
					</a-form-item>
				</a-col>
			</a-row>
			<a-row :gutter="8"> 
...
<script setup name="sysConfig">
	...
	const formRules = {
		...
		SNOWY_SYS_PRINT_HOST: [required('请输入系统打印服务器')]
	}
	// 表单固定label实现
	const labelCol = ref({
		style: {
